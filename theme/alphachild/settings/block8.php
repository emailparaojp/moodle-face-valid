...
$page = new admin_settingpage('theme_alphachild_block8', get_string('settingsblock8', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock8';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock8_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #8</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock8';
...
$name = 'theme_alphachild/block8class';
...
$name = 'theme_alphachild/block8introtitle';
...
$name = 'theme_alphachild/block8introcontent';
...
$name = 'theme_alphachild/block8htmlcontent';
...
$name = 'theme_alphachild/block8footercontent';
