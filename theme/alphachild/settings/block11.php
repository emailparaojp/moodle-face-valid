...
$page = new admin_settingpage('theme_alphachild_block11', get_string('settingsblock11', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock11';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock11_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #11</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock11';
...
$name = 'theme_alphachild/block11class';
...
$name = 'theme_alphachild/block11introtitle';
...
$name = 'theme_alphachild/block11introcontent';
...
$name = 'theme_alphachild/block11htmlcontent';
...
$name = 'theme_alphachild/block11footercontent';
