...
$page = new admin_settingpage('theme_alphachild_block3', get_string('settingsblock3', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock3';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock3_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #3 (Hero Image)</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/block3fw';
...
$name = 'theme_alphachild/block3class';
...
$name = 'theme_alphachild/block3wrapperalign';
$title = get_string('block3wrapperalign', 'theme_alphachild');
$description = get_string('block3wrapperalign_desc', 'theme_alphachild');
$default = 1;
$choices = array(0 => 'Left', 1 => 'Middle', 2 => 'Right');
$setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
$page->add($setting);

$name = 'theme_alphachild/showblock3wrapper';
$title = get_string('showblock3wrapper', 'theme_alphachild');
$description = get_string('showblock3wrapper_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title, $description, $default);
$page->add($setting);

$name = 'theme_alphachild/block3wrapperbg';
$title = get_string('block3wrapperbg', 'theme_alphachild');
$description = get_string('block3wrapperbg_desc', 'theme_alphachild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_alphachild/block3introcontent';
...
$name = 'theme_alphachild/block3herotitle';
$title = get_string('block3herotitle', 'theme_alphachild');
$description = get_string('block3herotitle_desc', 'theme_alphachild');
$setting = new admin_setting_configtextarea($name, $title, $description, '', PARAM_TEXT);
$page->add($setting);

$name = 'theme_alphachild/block3herosubheading';
$title = get_string('block3herosubheading', 'theme_alphachild');
$description = get_string('block3herosubheading_desc', 'theme_alphachild');
$setting = new admin_setting_configtextarea($name, $title, $description, '', PARAM_TEXT);
$page->add($setting);

$name = 'theme_alphachild/block3herotitlesize';
...
$name = 'theme_alphachild/block3herotitlecolor';
...
$name = 'theme_alphachild/block3herotitleweight';
...
$name = 'theme_alphachild/block3herocaption';
$title = get_string('block3herocaption', 'theme_alphachild');
$description = get_string('block3herocaption_desc', 'theme_alphachild');
...
$name = 'theme_alphachild/block3img';
$title = get_string('block3img', 'theme_alphachild');
$description = get_string('block3img_desc', 'theme_alphachild');
...
$name = 'theme_alphachild/block3htmlcontent';
...
$name = 'theme_alphachild/block3footercontent';
