...
$page = new admin_settingpage('theme_alphachild_block7', get_string('settingsblock7', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock7';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock7_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #7</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock7';
...
$name = 'theme_alphachild/block7class';
...
$name = 'theme_alphachild/block7introtitle';
...
$name = 'theme_alphachild/block7introcontent';
...
$name = 'theme_alphachild/block7htmlcontent';
...
$name = 'theme_alphachild/block7footercontent';
