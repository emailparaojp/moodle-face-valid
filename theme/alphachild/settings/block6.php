...
$page = new admin_settingpage('theme_alphachild_block6', get_string('settingsblock6', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock6';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock6_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #6</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock6';
...
$name = 'theme_alphachild/block6class';
...
$name = 'theme_alphachild/block6introtitle';
...
$name = 'theme_alphachild/block6introcontent';
...
$name = 'theme_alphachild/block6htmlcontent';
...
$name = 'theme_alphachild/block6footercontent';
