...
$page = new admin_settingpage('theme_alphachild_block16', get_string('settingsblock16', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock16';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock16_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #16</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock16';
...
$name = 'theme_alphachild/block16class';
...
$name = 'theme_alphachild/block16introtitle';
...
$name = 'theme_alphachild/block16introcontent';
...
$name = 'theme_alphachild/block16htmlcontent';
...
$name = 'theme_alphachild/block16footercontent';
...
$fileid = 'block16bg';
$name = 'theme_alphachild/block16bg';
...
$name = 'theme_alphachild/block16customcss';
