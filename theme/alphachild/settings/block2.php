...
$page = new admin_settingpage(
    'theme_alphachild_block2',
    get_string('settingsblock2', 'theme_alphachild')
);

$name = 'theme_alphachild/displayblock2';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock2_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #2 (Hero Video)</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/block2fw';
...
$name = 'theme_alphachild/block2class';
...
$name = 'theme_alphachild/block2wrapperalign';
$title = get_string('block2wrapperalign', 'theme_alphachild');
$description = get_string('block2wrapperalign_desc', 'theme_alphachild');
$default = 1;
$choices = array(0 => 'Left', 1 => 'Middle', 2 => 'Right');
$setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
$page->add($setting);

$name = 'theme_alphachild/showblock2wrapper';
$title = get_string('showblock2wrapper', 'theme_alphachild');
$description = get_string('showblock2wrapper_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title, $description, $default);
$page->add($setting);

$name = 'theme_alphachild/block2wrapperbg';
$title = get_string('block2wrapperbg', 'theme_alphachild');
$description = get_string('block2wrapperbg_desc', 'theme_alphachild');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_alphachild/block2introcontent';
...
$name = 'theme_alphachild/block2herotitle';
$title = get_string('block2herotitle', 'theme_alphachild');
$description = get_string('block2herotitle_desc', 'theme_alphachild');
$setting = new admin_setting_configtextarea($name, $title, $description, '', PARAM_TEXT);
$page->add($setting);

$name = 'theme_alphachild/block2herosubheading';
$title = get_string('block2herosubheading', 'theme_alphachild');
$description = get_string('block2herosubheading_desc', 'theme_alphachild');
$setting = new admin_setting_configtextarea($name, $title, $description, '', PARAM_TEXT);
$page->add($setting);

$name = 'theme_alphachild/block2herotitlesize';
...
$name = 'theme_alphachild/block2herotitlecolor';
...
$name = 'theme_alphachild/block2herotitleweight';
...
$name = 'theme_alphachild/block2herocaption';
$title = get_string('block2herocaption', 'theme_alphachild');
$description = get_string('block2herocaption_desc', 'theme_alphachild');
...
$name = 'theme_alphachild/block2htmlcontent';
...
$name = 'theme_alphachild/block2footercontent';
...
$name = 'theme_alphachild/block2videoposter';
$title = get_string('block2videoposter', 'theme_alphachild');
$description = get_string('block2videoposter_desc', 'theme_alphachild');
...
$name = 'theme_alphachild/block2videomp4';
$title = get_string('block2videomp4', 'theme_alphachild');
$description = get_string('block2videomp4_desc', 'theme_alphachild');
...
$name = 'theme_alphachild/block2videowebm';
$title = get_string('block2videowebm', 'theme_alphachild');
$description = get_string('block2videowebm_desc', 'theme_alphachild');
