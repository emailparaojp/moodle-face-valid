...
$page = new admin_settingpage('theme_alphachild_block18', get_string('settingsblock18', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock18';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock18_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #18</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock18';
...
$name = 'theme_alphachild/block18class';
...
$name = 'theme_alphachild/block18introtitle';
...
$name = 'theme_alphachild/block18introcontent';
...
$name = 'theme_alphachild/block18htmlcontent';
$title = get_string('blockhtmlcontent', 'theme_alphachild');
$description = get_string('block18htmlcontent_desc', 'theme_alphachild');
...
$name = 'theme_alphachild/block18footercontent';
