...
$page = new admin_settingpage('theme_alphachild_block17', get_string('settingsblock17', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock17';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock17_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #17</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock17';
...
$name = 'theme_alphachild/block17class';
...
$name = 'theme_alphachild/block17introtitle';
...
$name = 'theme_alphachild/block17introcontent';
...
$name = 'theme_alphachild/block17htmlcontent';
...
$name = 'theme_alphachild/block17footercontent';
...
$fileid = 'block17bg';
$name = 'theme_alphachild/block17bg';
...
$name = 'theme_alphachild/block17customcss';
