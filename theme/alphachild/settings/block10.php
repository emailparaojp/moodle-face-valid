...
$page = new admin_settingpage('theme_alphachild_block10', get_string('settingsblock10', 'theme_alphachild'));

$name = 'theme_alphachild/displayblock10';
$title = get_string('turnon', 'theme_alphachild');
$description = get_string('displayblock10_desc', 'theme_alphachild');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #10</span>', $description, $default);
$page->add($setting);

$name = 'theme_alphachild/displayhrblock10';
...
$name = 'theme_alphachild/block10class';
...
$name = 'theme_alphachild/block10introtitle';
...
$name = 'theme_alphachild/block10introcontent';
...
$name = 'theme_alphachild/block10htmlcontent';
...
$name = 'theme_alphachild/block10footercontent';
