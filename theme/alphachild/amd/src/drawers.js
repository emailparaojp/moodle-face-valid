 ...
 *
 * @module     theme_alphachild/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_alphachild/drawers:show}
     * @property {String} drawerShown See {@link event:theme_alphachild/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_alphachild/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_alphachild/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_alphachild/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_alphachild/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_alphachild/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_alphachild/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_alphachild/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_alphachild/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_alphachild/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_alphachild/drawers:hidden',
    };
     ...
     * @returns {module:theme_alphachild/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_alphachild/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_alphachild/drawers:close');
     ...
     *
     * @param {module:theme_alphachild/drawers} comparisonInstance
     */
