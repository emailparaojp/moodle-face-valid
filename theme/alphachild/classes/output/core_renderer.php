...
namespace theme_alphachild\output;
...
use theme_config;
use get_string;
use theme_alphachild\util\course;
use theme_alphachild\util\user;
...
class core_renderer extends \core_renderer {
    ...
    *
    */
    function theme_alphachild_themedir()
    {
        global $CFG;
    ...
    public function theme_part($name, $vars = array()) {
        ...
        if (file_exists($candidate1)) {
            ...
            $candidate = $CFG->dirroot . theme_alphachild_theme_dir() . '/alpha/layout/parts/' . $element;
        }
    ...
    protected function courseprogress($course) {
        global $USER;
        $theme = \theme_config::load('alphachild');
        ...
        if (get_class($courseformat) != 'format_tiles') {
            ...
            if ($completion->is_enabled()) {
                ...
                if (get_config('theme_alphachild', 'courseprogressbar') == 1) {
    ...
    public function mainsidebarmenu() {
        ...
        if (get_config('theme_alphachild', 'isitemonsitehome') == 1) {
            $isitemonsitehome = true;

            if (!empty(get_config('theme_alphachild', 'possitehome'))) {
        ...
        if (get_config('theme_alphachild', 'isitemondashboard') == 1) {
            $isitemondashboard = true;

            if (!empty(get_config('theme_alphachild', 'posdashboard'))) {
        ...
        if (get_config('theme_alphachild', 'isitemoncalendar') == 1) {
            $isitemoncalendar = true;

            if (!empty(get_config('theme_alphachild', 'poscalendar'))) {
        ...
        if (get_config('theme_alphachild', 'isitemoncontentbank') == 1) {
            $isitemoncontentbank = true;

            if (!empty(get_config('theme_alphachild', 'poscontentbank'))) {
        ...
        if (get_config('theme_alphachild', 'isitemonprivatefiles') == 1) {
            $isitemonprivatefiles = true;

            if (!empty(get_config('theme_alphachild', 'posprivatefiles'))) {
        ...
        if (get_config('theme_alphachild', 'isitemonmycourses') == 1) {
            $isitemonmycourses = true;

            if (!empty(get_config('theme_alphachild', 'posmycourses'))) {
        ...
        if ($theme->settings->iscustomitem1on == true) {
            ...
            $customitemrole1 = theme_alphachild_get_setting("customitemrole1");
        ...
        if ($theme->settings->iscustomitem2on == true) {
            ...
            // User role restriction.
            $customitemrole2 = theme_alphachild_get_setting("customitemrole2");
        ...
        if ($theme->settings->iscustomitem3on == true) {
            ...
            // User role restriction.
            $customitemrole3 = theme_alphachild_get_setting("customitemrole3");
        ...
        if ($theme->settings->iscustomitem4on == true) {
            ...
            // User role restriction.
            $customitemrole4 = theme_alphachild_get_setting("customitemrole4");
        ...
        if ($theme->settings->iscustomitem5on == true) {
            ...
            // User role restriction.
            $customitemrole5 = theme_alphachild_get_setting("customitemrole5");
    ...
    public function alpha_allcourseslink() {
        ...
        $allcoursetxt = format_text(
            theme_alphachild_get_setting('stringallcourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function alpha_mycourses_heading() {
        ...
        $detailstxt = format_text(
            theme_alphachild_get_setting('stringdetails'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function alpha_mycourses_heading_text() {
        ...
        $txt = format_text(
            theme_alphachild_get_setting('stringmycourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
    ...
    public function alpha_mycourses() {
        ...
        $nomycoursestxt = format_text(
            theme_alphachild_get_setting('stringnocourses'),
            FORMAT_HTML,
            array('noclean' => true)
        );
        ...
        $displayfilterhiddenchbx = theme_alphachild_get_setting('displayfilterhiddenchbx');
    ...
    public function moremenu_custom_items () {
        ...
        $theme = \theme_config::load('alphachild');
        $html = '';
        $secnavcount = theme_alphachild_get_setting('secnavitemscount');
        ...
        if ($this->page->theme->settings->secnavitems == 1) {
            ...
            for ($i = 1; $i <= $secnavcount; $i++) {
                $secnav->title = theme_alphachild_get_setting("secnavcustomnavlabel" . $i);

                $url = theme_alphachild_get_setting("secnavcustomnavurl" . $i);
                $courseid = $COURSE->id;
                $newurl = str_replace("{{courseID}}", $courseid, $url);
                $secnav->url = $newurl;
                
                // User role restriction.
                $selectrole = theme_alphachild_get_setting("secnavuserrole" . $i);
