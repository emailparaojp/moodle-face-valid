...
/**
 * Privacy Subsystem implementation for theme_alphachild.
 *
...
namespace theme_alphachild\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($darkmodepref)) {
            $preferencestring = get_string('privacy:darkmodeoff', 'theme_alphachild');
            if ($darkmodepref !== null) {
                $preferencestring = get_string('privacy:darkmodeon', 'theme_alphachild');
            }
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_alphachild');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_alphachild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_alphachild',
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_alphachild');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_alphachild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_alphachild',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_alphachild');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_alphachild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_alphachild',
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:rightdrawerclosed', 'theme_alphachild');
            if ($rightdraweropennpref !== null) {
                $preferencestring = get_string('privacy:rightdraweropen', 'theme_alphachild');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_alphachild',
                self::DRAWER_OPEN_NAV,
