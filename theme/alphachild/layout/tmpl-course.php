...
// Hidden sidebar.
if (theme_alphachild_get_setting('turnoffsidebarcourse') == '1') {
    $hiddensidebar = true;
    $navdraweropen = false;
...
$couseimagesettings = theme_alphachild_get_setting('setcourseimage');
...
echo $OUTPUT->render_from_template('theme_alphachild/tmpl-course', $templatecontext);
