...
/**
 * Quiz access faceserpro plugin upgrade code
 ...
 */
/**
 * Function to upgrade quizaccess_faceserpro.
 * * @param int $oldversion the version we are upgrading from
 * @return bool result
 */

function xmldb_quizaccess_faceserpro_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2021061102) {
        ...
        $table = new xmldb_table('quizaccess_faceserpro_logs');
        ...
        upgrade_plugin_savepoint(true, 2021061102, 'quizaccess', 'faceserpro');
    }

    if ($oldversion < 2021061104) {
        // Define field output to be added to task_log.
        $table = new xmldb_table('faceserpro_facematch_task');
        ...
        upgrade_plugin_savepoint(true, 2021061104, 'quizaccess', 'faceserpro');
    }

    if ($oldversion < 2021061106) {
        // Define field output to be added to task_log.
        $table = new xmldb_table('faceserpro_screenshot_logs');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, true, true, null, null);
        ...
        upgrade_plugin_savepoint(true, 2021061106, 'quizaccess', 'faceserpro');
    }
    ...
    if ($oldversion < 2021070702) {
        ...
        upgrade_plugin_savepoint(true, 2021070702, 'quizaccess', 'faceserpro');
    }

    if ($oldversion < 2021071405) {
        // Define field output to be added to task_log.
        $table = new xmldb_table('faceserpro_fm_warnings');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, true, true, null, null);
        $table->add_field('reportid', XMLDB_TYPE_INTEGER, '10', null, true, false, 0, null);
        $table->add_field('courseid', XMLDB_TYPE_INTEGER, '10', null, true, false, 0, null);
        $table->add_field('quizid', XMLDB_TYPE_INTEGER, '10', null, true, false, 0, null);
        ...
        upgrade_plugin_savepoint(true, 2021071405, 'quizaccess', 'faceserpro');
    }
    ...
    if ($oldversion < 2021112601) {
        ...
        // Drop table faceserpro_screenshot_logs.
        if ($dbman->table_exists($table)) {
            $dbman->drop_table($table);
        }
        upgrade_plugin_savepoint(true, 2021112601, 'quizaccess', 'faceserpro');
    }

    if ($oldversion < 2021112603) {
        // Define field output to be added to task_log.
        $table = new xmldb_table('faceserpro_user_images');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, true, true, null, null);
        ...
        upgrade_plugin_savepoint(true, 2021112603, 'quizaccess', 'faceserpro');
    }

    if ($oldversion < 2021112604) {
        // Define field output to be added to task_log.
        $table = new xmldb_table('faceserpro_face_images');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, true, true, null, null);
        ...
        upgrade_plugin_savepoint(true, 2021112604, 'quizaccess', 'faceserpro');
    }
    return true;
}
