...
/**
 * Strings for the quizaccess_faceserpro plugin.
 *
...
$string['faceserprorequired_help'] = 'If you enable this option, students will not be able to start an attempt until they have ticked a check-box confirming that they are aware of the policy on webcam.';
$string['faceserprorequiredoption'] = 'must be acknowledged before starting an attempt';
$string['notrequired'] = 'not required';
$string['privacy:metadata'] = 'We do not share any personal data with third parties.';
$string['faceserproheader'] = '<strong>To continue with this quiz attempt you must open your webcam, and it will take some of your pictures randomly during the quiz.</strong>';
$string['faceserprolabel'] = 'I agree with the validation process.';
...
$string['faceserprostatement'] = 'This exam requires webcam access.<br />(Please allow webcam access).';
...
$string['quizaccess_faceserpro'] = 'Quizaccess faceserpro';
$string['youmustagree'] = 'You must agree to validate your identity before continue.';
$string['faceserprorequired'] = 'Webcam identity validation';
$string['notpermissionreport'] = 'faceserpro reports are disabled for you.';
$string['eprotroringreports'] = 'faceserpro report for: ';
...
$string['summarypagedesc'] = 'In this report you will find the summary of faceserpro report for course and quizzes. You can delete all the data related to quiz and course. It will delete image file as well as logs.';
$string['status'] = 'Validation status';
$string['dateverified'] = 'Date and time';
$string['warninglabel'] = 'Warnings';
$string['actions'] = 'Actions';
$string['picturesreport'] = 'View faceserpro report';
$string['screenshots'] = 'Screenshots';
$string['picturesusedreport'] = 'There are the pictures captured during the quiz.';
$string['faceserproproavailable'] = 'faceserpro Pro is now available!';
$string['buyfaceserpropro'] = 'Get faceserpro Pro';
$string['togglereportimage'] = 'Toggle Image View';
$string['setting:faceserproreconfigurefaceserpro'] = 'Auto-configure faceserpro';
$string['setting:faceserproreconfigurefaceserpro_desc'] = 'If enabled, users who navigate to the quiz take webcam pictures';
...
$string['privacy:metadata:courseid'] = 'The ID of the course that use faceserpro.';
$string['privacy:metadata:quizid'] = 'The ID of the Quiz that use faceserpro.';
$string['privacy:metadata:webcampicture'] = 'The name of picture that has been taken by the faceserpro.';
$string['privacy:metadata:status'] = 'The Status of the faceserpro.';
$string['timemodified'] = 'Last modified';
$string['privacy:metadata:quizaccess_faceserpro_logs'] = 'Moodle Quiz access faceserpro logs table that store user\'s picture.';
$string['faceserpro:sendcamshot'] = 'faceserpro send webcam photo';
$string['faceserpro:getcamshots'] = 'faceserpro get webcam photos';
$string['faceserpro:viewreport'] = 'faceserpro view report';
$string['name'] = 'Student Name';
$string['webcampicture'] = 'Captured Pictures';
$string['openwebcam'] = 'Allow your webcam to continue';
$string['privacy:quizaccess_faceserpro_logs'] = 'QuizAccess faceserpro logs';
$string['privacy:core_files'] = 'QuizAccess faceserpro webcam pictures';
...
$string['mainsettingspagebtn'] = 'faceserpro Settings';
$string['additionalsettingspagetitle'] = 'All faceserpro logs';
