...
/**
 * Additional Settings Helper for the quizaccess_faceserpro plugin.
...
class AdditionalSettingsHelper {
    ...
    /**
     * Search for specific user faceserpro log.
     *
    ...
    public function search(string $username, string $email, string $coursename, string $quizname) {
        ...
        $sql = "SELECT"
            ...
            ." q.name as quizname "
            ." from  {quizaccess_faceserpro_logs} e "
    ...
    public function deletelogs ($deleteidstring) {
        ...
        if (count($deleteids) > 0) {
            ...
            $sql = "SELECT * FROM {quizaccess_faceserpro_logs} WHERE id $insql";
            ...
            foreach ($logs as $row) {
                ...
                $DB->delete_records('faceserpro_fm_warnings', array('reportid' => $id));
                $DB->delete_records('quizaccess_faceserpro_logs', array('id' => $id));
