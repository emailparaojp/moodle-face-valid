...
/**
 * Delete Images for the quizaccess_faceserpro plugin.
...
$pageurl = new moodle_url('/mod/quiz/accessrule/faceserpro/externalsettings.php');
$PAGE->set_url($pageurl);

$DB->delete_records('quizaccess_faceserpro_logs');
// Delete users file (webcam images).
$filesql = 'SELECT * FROM {files} WHERE component = \'quizaccess_faceserpro\' AND filearea = \'picture\'';
...
endforeach;
$url = new moodle_url('/');
redirect($url, get_string('settings:deleteallsuccess', 'quizaccess_faceserpro'), -11, 'success');
