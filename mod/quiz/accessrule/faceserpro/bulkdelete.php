...
/**
 * Bulk Delete for the quizaccess_faceserpro plugin.
...
$PAGE->set_url($url);
$PAGE->set_title('faceserpro:Bulk Delete');
$PAGE->set_heading('faceserpro Bulk Delete');

$PAGE->navbar->add('faceserpro: Bulk Delete', $url);
