...
/**
 * Additional Settings for the quizaccess_faceserpro plugin.
 ...
 */
const ADDITIONAL_SETTINGS = '/mod/quiz/accessrule/faceserpro/additional_settings.php';
$url = new moodle_url(
    ADDITIONAL_SETTINGS,
    $params
);
...
$PAGE->set_url($url);
$PAGE->set_title('faceserpro logs');
$PAGE->set_heading('faceserpro Logs');
$PAGE->navbar->add('faceserpro Logs', $url);
...
$table->define_headers(
    array(
        get_string('reportidheader', 'quizaccess_faceserpro'),
        get_string('user'),
        get_string('email'),
        get_string('coursenameheader', 'quizaccess_faceserpro'),
        get_string('quiznameheader', 'quizaccess_faceserpro'),
...
foreach ($sqlexecuted as $info) {
    $reporturl = new moodle_url('/mod/quiz/accessrule/faceserpro/report.php');
