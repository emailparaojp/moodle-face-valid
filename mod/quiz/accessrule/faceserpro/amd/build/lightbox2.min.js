define("quizaccess_faceserpro/lightbox2", ["jquery"], function ($) {
              ...
              if (urlsplit.length > 0)
                for (
                  ...
                  if (tmpid.includes("reportid-")) {
                    var imgrowid = tmpid.split("-")[1],
                      url_string = window.location.href,
                      url = new URL(url_string),
                      cCourseId = url.searchParams.get("courseid"),
                      cQuizId = url.searchParams.get("quizid"),
                      cCmId = url.searchParams.get("cmid"),
                      cStudentId = url.searchParams.get("studentid"),
                      cReportId = url.searchParams.get("reportid"),
                      newUrl =
                        url_string.split("report.php")[0] +
                        "analyzesingleimage.php?courseid=" +
                        cCourseId +
                        "&quizid=" +
                        cQuizId +
                        "&cmid=" +
