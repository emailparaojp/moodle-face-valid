let isCameraAllowed = !1;
define("quizaccess_faceserpro/faceserpro", [
  "jquery",
  "core/ajax",
  "core/notification",
], function ($, Ajax, Notification) {
  function hideButtons() {
    $(".mod_quiz-next-nav").prop("disabled", !0),
      $(".submitbtns").html(
    ...
    $(function () {
      $("#id_submitbutton").prop("disabled", !0),
        $("#id_faceserpro").on("change", function () {
          this.checked && isCameraAllowed
            ? $("#id_submitbutton").prop("disabled", !1)
            : $("#id_submitbutton").prop("disabled", !0);
        });
    });
  ...
  return {
    async setup(props, modelurl) {
      if (
        ...
        null !== document.getElementById("page-mod-quiz-summary") &&
          document.getElementById("page-mod-quiz-summary").innerHTML.length)
      )
        return !1;
      if (
        null !== document.getElementById("page-mod-quiz-review") &&
      ...
      $("#mod_quiz_navblock").append(
        '<div class="card-body p-3"><h3 class="no text-left">Webcam</h3> <br/><video id="video">Video stream not available.</video><img id="cropimg" src="" alt=""/><canvas id="canvas" style="display:none;"></canvas><div class="output" style="display:none;"><img id="photo" alt="The picture will appear in this box."/></div></div>'
      );
      const video = document.getElementById("video"),
        ...
        takepicture = async () => {
          ...
          if (width && height) {
            ...
            null != modelurl && (await detectface(photo, croppedImage)),
              croppedImage.src
                ? (null != modelurl &&
                    (console.log("Face found"), removeNotifications()),
                  (faceFound = 1),
                ...
                : (null != modelurl &&
                  ...
                  (faceImage = ""));
            var request = {
              methodname: "quizaccess_faceserpro_send_camshot",
              args: {
      ...
      return (
        navigator.mediaDevices
          ...
          .then(function (stream) {
            (video.srcObject = stream), video.play(), (isCameraAllowed = !0);
          })
          .catch(function () {
            hideButtons();
          }),
        video
          ? (video.addEventListener(
            ...
            video.addEventListener(
              "click",
              async function (ev) {
                await takepicture(), ev.preventDefault();
              },
              !1
            ),
            setTimeout(takepicture, 3e3),
                        ...
                        Ajax.call([request])[0]
                          .done(async function (res) {
                            res.warnings.length < 1 ||
                              Notification.addNotification({
                                message:
                                  "Something went wrong during taking screenshot.",
                                type: "error",
                              });
                          })
                          .fail(Notification.exception);
...
//# sourceMappingURL=faceserpro.min.js.map
