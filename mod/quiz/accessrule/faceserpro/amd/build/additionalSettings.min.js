define("quizaccess_faceserpro/additionalSettings", [
  "jquery",
  "core/ajax",
  "core/notification",
], function ($) {
  return {
    setup: function () {
      function refreshDeleteIdStringValue() {
        const idArray = [],
          checkBoxArray = document.getElementsByClassName("reportIdChkBox");
        for (var index = 0; index < checkBoxArray.length; index++)
          checkBoxArray[index].checked &&
      ...
      return (
        $("#select_all").click(function () {
          const checkBox = document.getElementById("select_all"),
            btn = document.getElementById("delete_select_btn");
          !0 === checkBox.checked
            ? ((btn.style.display = "block"),
              $(".reportIdChkBox").prop("checked", !0))
            : ((btn.style.display = "none"),
              $(".reportIdChkBox").prop("checked", !1)),
