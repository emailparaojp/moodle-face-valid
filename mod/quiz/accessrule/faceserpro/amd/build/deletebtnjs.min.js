define("quizaccess_faceserpro/deletebtnjs", [
  "jquery",
  "core/ajax",
  "core/notification",
], function () {
    ...
    setup: function (props) {
      if (
        window.location.href.includes(
          "/admin/settings.php?section=modsettingsquizcatfaceserpro"
        )
      ) {
        ...
        const confirmmsg = props.deleteconfirm,
          ...
          btntag = document.createElement("a"),
          text = document.createTextNode(props.btnlabel);
        (btntag.className = "btn btn-warning"),
          (btntag.href = props.pageurl),
          btntag.appendChild(text),
          btntag.addEventListener("click", confirmIt, !1),
          btnContainer.appendChild(btntag),
          div.appendChild(labelcontainer),
          div.appendChild(btnContainer);
        const adminforms = document.getElementsByClassName("settingsform");
        adminforms.length > 0 && adminforms[0].appendChild(div);
      }
      return (
        "None" == $("#id_s_quizaccess_faceserpro_fcmethod :selected").text() &&
          ($("#id_s_quizaccess_faceserpro_fcheckstartchk").prop("checked", !1),
          $("#id_s_quizaccess_faceserpro_fcheckstartchk").prop("disabled", !0)),
        $("#id_s_quizaccess_faceserpro_fcmethod").click(function () {
          "None" == $("#id_s_quizaccess_faceserpro_fcmethod :selected").text()
            ? ($("#id_s_quizaccess_faceserpro_fcheckstartchk").prop(
                "checked",
                !1
              ),
              $("#id_s_quizaccess_faceserpro_fcheckstartchk").prop(
