...
/**
 * Unit tests for the core_quiz implementation of the privacy API.
/**
...
use \core_quiz\privacy\provider;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class core_quiz_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $prefs = $writer->get_user_preferences('core_quiz');
        $this->assertCount(1, (array) $prefs);
        $this->assertEquals(HOMEPAGE_quiz, $prefs->user_home_page_preference->value);
    }
