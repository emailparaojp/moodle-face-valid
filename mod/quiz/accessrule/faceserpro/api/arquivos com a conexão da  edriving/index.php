...
if(isset($_SESSION['USER']->confirmed) && !$_SESSION['biometria_ok'] && $_SESSION['USER']->id != 2){
    ...
    if($_REQUEST['valida']) {
        ...
        if($biometria->biometria_face) {
            ...
            if($biometria->biometria_face->similaridade >= 0.85) {
                ...
                $fp = fopen(__DIR__ . '/relatorio.csv', 'a+');
    ...
    if(!$biometria_ok) {
        ...
        <html lang="pt-BR">
            <head>
                <!--Título-->
                <title>SERPRO - Coleta de Biometria Facial</title>
                <meta charset="UTF-8">
                <meta name="viewport" content="width=device-width, initial-scale=1">
                <meta name="description" content="Validacao Biometria (SERPRO)"/>
                <!--OpenType-->
                <meta property="og:locale" content="pt_BR" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Validação Serpro" />
                <meta property="og:description" content="Validacao Biometria (SERPRO)" />
                <meta property="og:url" content="" />
                <meta property="og:site_name" content="Validação Serpro" />
                <!--CSS-->
                <link rel="stylesheet" type="text/css" href="./css/styles.css" media="screen" />
            </head>
            <body>
                <div class="bloco">
                    <h2>De acordo com o que determina o SERPRO, você deve se autenticar</h2>
